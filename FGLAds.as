package
{
	...
	dynamic public class FGLAds extends Sprite
	{
		...
		private var _stageHeight:Number = 480;
		...
		public function FGLAds(parent:*, gameID:String, config:Object = null):void
		{
			if(_instance == null) {
				_instance = this;
			} else {
			...
			var override:URLRequest = checkConfig(config, 'swf_url', URLRequest);
			if(override != null) {
